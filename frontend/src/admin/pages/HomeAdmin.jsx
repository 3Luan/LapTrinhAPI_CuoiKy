...
const HomeAdmin = () => {
  ...
  return (
    <div className="w-full px-0 lg:px-10 pb-20 2xl:px-40 bg-gray-200 rounded-lg h-screen overflow-hidden">
      <HeaderAdmin />
      <div className="w-full flex gap-2 lg:gap-4 h-full">
        ...
        <div className="flex-1 h-full flex flex-col gap-2 overflow-y-auto rounded-lg bg-white mt-4">
          <div className="ml-2 mt-4 border-b pb-4">
            <CustomButton
              title="Ngày"
              containerStyles={`bg-blue-700 text-white text-lg ml-4 mr-2 mt-1 py-2 px-4 rounded-md font-semibold text-sm`}
              onClick={onClickDay}
            />
            <CustomButton
              title="Tháng"
              containerStyles={`bg-blue-700 text-white text-lg mx-2 mt-1 py-2 px-4 rounded-md font-semibold text-sm`}
